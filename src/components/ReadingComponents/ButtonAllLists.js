...
const ButtonAllLists = () => {
  const navigate = useNavigate(); // Hook para manejar la navegación
  const handleGoToAllLists = () => {
    navigate('/readings-list/all'); // Ruta del ReadingsAll
  };
  return(
    <button onClick={handleGoToAllLists} >
