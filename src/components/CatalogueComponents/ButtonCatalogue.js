/* Button component for the catalogue view. This component receives the following props: 
  ...
  The ButtonCatalogue component renders a button with the label passed as props.
  When the button is clicked, the onClick function is executed. */

import React from 'react';

const ButtonCatalogue = ({ label, onClick }) => (
  <button className="button-catalogue" onClick={onClick}>
